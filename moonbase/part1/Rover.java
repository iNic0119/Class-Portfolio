...
public class Rover implements Runnable {
    ...
    //constructor
    public Rover(String name, int seconds, Base from, Base to){
        this.name=name;
    ...
    public static void main(String[] args) {
        ...
        Rover rov = new Rover("Rov", 10, Base.Hyperion, Base.Odyssey);
        Thread thread1 = new Thread(rov);
        Rover rovJr = new Rover("RovJr", 5, Base.Hyperion, Base.Odyssey);
        Thread thread2 = new Thread(rovJr);
        Rover rusty = new Rover("Rusty", 15, Base.Odyssey, Base.Hyperion);
        Thread thread3 = new Thread(rusty);
        Rover cyberRover = new Rover("David", 2, Base.Odyssey, Base.Hyperion);
